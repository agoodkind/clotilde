...
// short non-streaming requests). The flavor is generated by
// `clyde mitm codegen` from research/claude-code/snapshots/latest/reference.toml
// so identity drift surfaces in the wire-snapshot-check CI gate.
