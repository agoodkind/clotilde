...
func ChunksContainToolCalls(chunks []adapteropenai.StreamChunk) bool {
...
func assembleToolCalls(chunks []adapteropenai.StreamChunk) map[string]*assembledToolCall {
...
func ToolCallsHaveUsableArguments(chunks []adapteropenai.StreamChunk) bool {
...
func CollectAssistantText(chunks []adapteropenai.StreamChunk) string {
...
func ShouldEscalateDirect(req adapteropenai.ChatRequest, chunks []adapteropenai.StreamChunk, finishReason string) (bool, string) {
