...
func TestShouldEscalateWhenToolCallsAssembleToEmptyObject(t *testing.T) {
	...
	chunks := []adapteropenai.StreamChunk{
		{Choices: []adapteropenai.StreamChoice{{Delta: adapteropenai.StreamDelta{ToolCalls: []adapteropenai.ToolCall{{Index: 0, ID: "call_1", Type: "function", Function: adapteropenai.ToolCallFunction{Name: "Glob"}}}}}}},
		{Choices: []adapteropenai.StreamChoice{{Delta: adapteropenai.StreamDelta{ToolCalls: []adapteropenai.ToolCall{{Index: 0, ID: "call_1", Type: "function", Function: adapteropenai.ToolCallFunction{Arguments: "{"}}}}}}},
		{Choices: []adapteropenai.StreamChoice{{Delta: adapteropenai.StreamDelta{ToolCalls: []adapteropenai.ToolCall{{Index: 0, ID: "call_1", Type: "function", Function: adapteropenai.ToolCallFunction{Arguments: "}"}}}}}}},
	}
	escalate, reason := ShouldEscalateDirect(req, chunks, "tool_calls")
	if !escalate {
