...
type SynthOptions struct {
	...
	// (typically via a claude -p summarization call). Empty means the
...
func renderHeader(slice *Slice, opts SynthOptions) string {
	...
	if stats.ThinkingBlocks+stats.Images+stats.ToolsLineOnly+stats.ToolsDropped+stats.ChatTurns > 0 {
